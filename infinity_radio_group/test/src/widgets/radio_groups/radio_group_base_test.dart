...
import 'package:infinity_radio_group/src/configs/radio_group_layout_config.dart';
import 'package:infinity_radio_group/src/models/radio_item_ui_model.dart';
import 'package:infinity_radio_group/src/widgets/radio_groups/radio_group_base.dart';
...
void main() {
  ...
  testWidgets('Changing initialSelectionIndex updates selection on rebuild',
      (tester) async {
    final models = [
      // ignore: prefer_const_constructors
      _TestRadioItemUiModel(shouldBeSelected: true),
      // ignore: prefer_const_constructors
      _TestRadioItemUiModel(shouldBeSelected: true),
    ];

    var initialSelectionIndex = 1;
  ...
  testWidgets(
      'Changing initialSelectionIndex to invalid value keeps current selection',
      (tester) async {
    final models = [
      // ignore: prefer_const_constructors
      _TestRadioItemUiModel(shouldBeSelected: true),
