...
import 'package:infinity_selection_group/infinity_selection_group.dart' as custom_selection_group;
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'infinity_selection_group example',
      theme: ThemeData(
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: const Text('infinity_selection_group example'),
