...
See [Flavors](CONVENTIONS.md#flavors) section in CONVENTIONS.md for the purpose of each flavor.
...
- **Launcher icon:<br>**
  ...
  ```
  See [Code generation](CONVENTIONS.md#code-generation) for more details on running code generation
  commands.
