...
void main() {
  ...
  const defaultLogDirectoryRelativePathFromProjectRoot =
      'logs/analysis_plugins/json_parser_linter';
  ...
  late JsonParserLinterConfigLoader sut;
  ...
  setUp(() {
    ...
    sut = JsonParserLinterConfigLoader.test(
  ...
  test(
    ...
    () {
      ...
      log_config:
        ...
        allow_warning: true
        allow_error: true
        log_dir_relative_path: analysis_logs/analysis_plugins/json_parser_linter/
      ...
      expect(
        ...
        isA<JsonParserLinterConfig>()
            ...
            .having(
              ...
              'analysis_logs/analysis_plugins/json_parser_linter/',
            )
            .having(
