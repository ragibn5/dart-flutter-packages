...
- Available companion tools:
    - [`json_parser_generator`](json_parser_generator/README.md): Generates type-safe JSON parser [registries](#-building-a-parser-registry) for annotated models.
    - [`json_parser_linter`](json_parser_linter/README.md): Adds analyzer checks to enforce `json_parser`-compatible model structures.
