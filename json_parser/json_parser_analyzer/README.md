...
dev_dependencies:
  json_parser_analyzer:
    git:
      ...
      path: json_parser/json_parser_analyzer
      ref: json_parser/json_parser_analyzer-1.0.0
```
...
### 2. Create a `json_parser_analyzer_config.yaml` file at the root of your project.
...
The plugin looks for `json_parser_analyzer_config.yaml` in the package root. If the file is
