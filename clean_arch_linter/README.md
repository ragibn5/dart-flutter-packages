...
### 2. Create a `clean_arch_linter_config.yaml` file at the root of your project.
...
The plugin looks for `clean_arch_linter_config.yaml` in the package root. If the file is missing
